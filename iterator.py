#Slightly modified from Francis Dutil : https://github.com/Dutil/IFT6266
...
class Iterator(object):
    ...
    def __init__(self, which_set, root_path="datasets/inpainting",
                 ...
                 dict_path = 'worddict.pkl',
                 batch_size=128, nb_sub=None, extract_center=True, load_caption=True, process_text=True):
        ...
        self.dict_path = os.path.join(self.root_path, dict_path)
